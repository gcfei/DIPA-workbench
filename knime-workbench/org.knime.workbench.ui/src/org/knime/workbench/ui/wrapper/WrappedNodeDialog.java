...
public class WrappedNodeDialog extends AbstractWrappedDialog {
    ...
    public WrappedNodeDialog(final Shell parentShell, final NodeContainerUI nodeContainer) throws NotConfigurableException {
        ...
        m_dialogPane =
            ncAsyncSwitchRethrow(nc -> nc.getDialogPaneWithSettings(), nc -> nc.getDialogPaneWithSettingsAsync(),
                nodeContainer, Messages.WrappedNodeDialog_0);
    ...
    protected void configureShell(final Shell newShell) {
        ...
        rootItem.setText(Messages.WrappedNodeDialog_1);
        ...
        itemLoad.setText(Messages.WrappedNodeDialog_2);
        ...
        itemSave.setText(Messages.WrappedNodeDialog_3);
            ...
            public void widgetSelected(final SelectionEvent e) {
                ...
                if (file != null) {
                    ...
                    try {
                        ...
                        showErrorMessage(Messages.WrappedNodeDialog_4
                                + ise.getMessage());
                        // SWT-AWT-Bridge doesn't properly
                        // repaint after dialog disappears
                        m_dialogPane.getPanel().repaint();
    ...
    protected Control createDialogArea(final Composite parent) {
        ...
        getShell().setText(Messages.WrappedNodeDialog_5 + m_nodeContainer.getDisplayLabel());
    ...
    protected void createButtonsForButtonBar(final Composite parent) {
        ...
        m_applyButton = createButton(parent, IDialogConstants.FINISH_ID, Messages.WrappedNodeDialog_6, false);
        ...
        m_swtKeyListener = new KeyListener() {
            ...
            public void keyReleased(final KeyEvent ke) {
                if (ke.keyCode == SWT.MOD1) {
                    m_okButton.setText(Messages.WrappedNodeDialog_7);
                }
            }
            ...
            public void keyPressed(final KeyEvent ke) {
                ...
                if (ke.keyCode == SWT.MOD1 && canExecutePredicate.test(m_nodeContainer)) {
                    ...
                    m_okButton.setText(Messages.WrappedNodeDialog_8);
                }
                if ((ke.keyCode == SWT.CR) && ((ke.stateMask & SWT.MOD1) != 0)) {
                    ...
                    if (!ke.doit) {
                        m_okButton.setText(Messages.WrappedNodeDialog_9);
                    }
                }
            }
        };
        m_awtKeyListener = new KeyAdapter() {
                ...
                if (ke.getKeyCode() == menuAccelerator) {
                    Display.getDefault().asyncExec(() -> {
                        if (!m_okButton.isDisposed()) {
                            m_okButton.setText(Messages.WrappedNodeDialog_10);
                        }
                    });
                }
            }
            ...
            public void keyPressed(final java.awt.event.KeyEvent ke) {
                ...
                if ((ke.getKeyCode() == menuAccelerator) && canExecutePredicate.test(m_nodeContainer)) {
                    ...
                    Display.getDefault().asyncExec(() -> {
                        if (!m_okButton.isDisposed()) {
                            m_okButton.setText(Messages.WrappedNodeDialog_11);
                        }
                    });
                }
                ...
                if ((ke.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER)
                    ...
                    Display.getDefault().asyncExec(() -> {
                        ...
                        if (doApply()) {
                            ...
                            // reset ok button state/label
                            m_okButton.setText(Messages.WrappedNodeDialog_12);
                        }
                    });
                }
            }
        ...
        m_okButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent se) {
                ...
                if (!se.doit) {
                    // reset ok button state/label
                    if (!m_okButton.isDisposed()) {
                        m_okButton.setText(Messages.WrappedNodeDialog_13);
                    }
                }
            }
        });
        ...
        m_applyButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent se) {
                ...
                // reset ok button state/label
                if (!m_okButton.isDisposed()) {
                    m_okButton.setText(Messages.WrappedNodeDialog_14);
                }
            }
        });
    ...
    private boolean doApply() {
        ...
        try {
            ...
            if (m_nodeContainer.getNodeContainerState().isExecuted()) {
                if (m_nodeContainer.areDialogAndNodeSettingsEqual()) {
                    ...
                    if (m_nodeContainer.areDialogSettingsValid()) {
                        ...
                        throw new IllegalStateException(Messages.WrappedNodeDialog_15);
                    }
                }
            } else {
                // not executed
            ...
            LOGGER.warn(Messages.WrappedNodeDialog_16 + ise.getMessage(), ise);
            showWarningMessage(Messages.WrappedNodeDialog_17 + ise.getMessage());
            // SWT-AWT-Bridge doesn't properly repaint after dialog disappears
            m_dialogPane.getPanel().repaint();
        } catch (IllegalStateException ex) {
            LOGGER.warn(Messages.WrappedNodeDialog_18 + ex.getMessage(), ex);
            showWarningMessage(Messages.WrappedNodeDialog_19 + ex.getMessage());
            // SWT-AWT-Bridge doesn't properly repaint after dialog disappears
            m_dialogPane.getPanel().repaint();
        } catch (Throwable t) {
            LOGGER.error(Messages.WrappedNodeDialog_20 + t.getMessage(), t);
            ...
            final MessageDialogWithToggle dialog =
                    MessageDialogWithToggle
                            .openOkCancelConfirm(
                                    ...
                                    Messages.WrappedNodeDialog_22,
                                    Messages.WrappedNodeDialog_23
                                            + Messages.WrappedNodeDialog_24
                                            + Messages.WrappedNodeDialog_25,
                                    Messages.WrappedNodeDialog_26, false, null, null);
    ...
    static {
        ...
        final int scrollBarWidthOrHeight = ((Integer)UIManager.get("ScrollBar.width")).intValue(); //$NON-NLS-1$
