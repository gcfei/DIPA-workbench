...
public class DatabaseDriverListEditor extends ListEditor {
     ...
     * method.*/
    private static final String VALUE_SPLIT = ";"; //$NON-NLS-1$
    ...
    public Composite getButtonBoxControl(final Composite parent) {
        ...
        if (m_fileButton == null) {
            m_fileButton = createPushButton(buttonBox, Messages.DatabaseDriverListEditor_1);
        ...
        getAddButton().setText(Messages.DatabaseDriverListEditor_2);
        return buttonBox;
    }
    /*
    ...
    protected String getNewInputObject() {
        ...
        dialog.setMessage(Messages.DatabaseDriverListEditor_5);
        if (lastPath != null) {
    ...
    protected String[] parseString(final String string) {
        ...
        if (!failed.isEmpty()) {
            m_page.setErrorMessage(Messages.DatabaseDriverListEditor_6 + failed.toString());
        }
