...
public class KNIMEUIPlugin extends AbstractUIPlugin {
    ...
    /** The plugin ID. */
    public static final String PLUGIN_ID = "org.knime.workbench.ui"; //$NON-NLS-1$
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        if (Display.getCurrent() != null) {
            ...
            getImageRegistry().put("knime", //$NON-NLS-1$
                    imageDescriptorFromPlugin(PLUGIN_ID,
                            "/icons/dipa_default.png")); //$NON-NLS-1$
        }
            ...
            public void propertyChange(final PropertyChangeEvent event) {
                ...
                if (PreferenceConstants.P_FAV_FREQUENCY_HISTORY_SIZE.equals(
                    ...
                    try {
                        ...
                        LOGGER.error(Messages.KNIMEUIPlugin_3
                                + Messages.KNIMEUIPlugin_4, e);
                    }
                    ...
                    try {
                        ...
                        LOGGER.error(Messages.KNIMEUIPlugin_5
                                + Messages.KNIMEUIPlugin_6, e);
                    }
        ...
        try {
            ...
            LOGGER.error(Messages.KNIMEUIPlugin_7, e);
        }
        ...
        IDialogSettings ds2 = ds.getSection("AvailableIUsPage"); //$NON-NLS-1$
        if (ds2 == null) {
           ds2 = ds.addNewSection("AvailableIUsPage"); //$NON-NLS-1$
           ds2.put("HideInstalledContent", true); //$NON-NLS-1$
        } else if (ds2.get("HideInstalledContent") == null) { //$NON-NLS-1$
            ds2.put("HideInstalledContent", true); //$NON-NLS-1$
        }
    }
    ...
    public ResourceBundle getResourceBundle() {
        try {
            if (m_resourceBundle == null) {
                m_resourceBundle =
                        ResourceBundle
                                .getBundle("org.knime.workbench.ui.Resources"); //$NON-NLS-1$
            }
