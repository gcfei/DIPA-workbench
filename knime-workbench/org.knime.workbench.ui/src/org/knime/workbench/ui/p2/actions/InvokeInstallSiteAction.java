...
public class InvokeInstallSiteAction extends AbstractP2Action {
    private static final String ID = "INVOKE_INSTALL_SITE_ACTION"; //$NON-NLS-1$

    /**
     *
     */
    public InvokeInstallSiteAction() {
        super(Messages.InvokeInstallSiteAction_1, Messages.InvokeInstallSiteAction_2
                + Messages.InvokeInstallSiteAction_3, ID);
    }
