...
public class MetaInfoPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        addField(new FileFieldEditor(
                ...
                Messages.MetaInfoPreferencePage_0, true,
                getFieldEditorParent()));

        addField(new FileFieldEditor(
                MetaInfoFile.PREF_KEY_META_INFO_TEMPLATE_WFS,
                Messages.MetaInfoPreferencePage_1, true,
                getFieldEditorParent()));
    }
    ...
    public void init(final IWorkbench workbench) {
        ...
        prefStore.setDefault(MetaInfoFile.PREF_KEY_META_INFO_TEMPLATE_WF, ""); //$NON-NLS-1$
        prefStore.setDefault(MetaInfoFile.PREF_KEY_META_INFO_TEMPLATE_WFS, ""); //$NON-NLS-1$
