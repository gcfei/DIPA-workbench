...
public class CredentialVariablesEditDialog extends Dialog {
    ...
    public void loadFrom(final Credentials credential) {
        ...
        m_login.setText(login == null ? "" : login); //$NON-NLS-1$
        String password = credential.getPassword();
        m_pass.setText(password == null ? "" : password); //$NON-NLS-1$
    ...
    protected Control createDialogArea(final Composite parent) {
        parent.getShell().setText(Messages.CredentialVariablesEditDialog_2);
        ...
        passwordLabel.setText(Messages.CredentialVariablesEditDialog_5);
    ...
    protected void okPressed() {
        ...
        if (varName.isEmpty()) {
            String msg = Messages.CredentialVariablesEditDialog_6;
            showError(msg);
    ...
    private void showError(final String message) {
        MessageDialog.openError(getParentShell(), Messages.CredentialVariablesEditDialog_7, message);
    }
