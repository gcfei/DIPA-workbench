...
public class AutoLayoutAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.autolayout"; //$NON-NLS-1$
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getImageDescriptor(Activator.PLUGIN_ID, "icons/layout.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getImageDescriptor(Activator.PLUGIN_ID, "icons/layout_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.AutoLayoutAction_3;
    }
