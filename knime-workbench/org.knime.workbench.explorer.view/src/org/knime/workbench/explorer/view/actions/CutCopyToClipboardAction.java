...
//            CutCopyToClipboardAction.class);
    ...
    public CutCopyToClipboardAction(final ExplorerView view,
        ...
        ID = "org.knime.workbench.explorer.view.actions." //$NON-NLS-1$
            + (performCut ? Messages.getString("CutCopyToClipboardAction.1") : Messages.getString("CutCopyToClipboardAction.2")); //$NON-NLS-1$ //$NON-NLS-2$
    }
