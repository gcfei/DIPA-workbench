...
final class WorkflowImportHelper {
    ...
    static final ImageDescriptor ICON = AbstractUIPlugin.imageDescriptorFromPlugin(KNIMEUIPlugin.PLUGIN_ID,
        "icons/dipa_import.png"); //$NON-NLS-1$

    static final String MENU_TEXT = Messages.getString("WorkflowImportHelper.1"); //$NON-NLS-1$

    static final String TOOLTIP = Messages.getString("WorkflowImportHelper.2"); //$NON-NLS-1$
