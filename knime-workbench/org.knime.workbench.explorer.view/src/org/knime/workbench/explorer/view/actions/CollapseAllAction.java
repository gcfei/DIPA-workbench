...
public class CollapseAllAction extends ExplorerAction {
    private static final String TOOLTIP = Messages.getString("CollapseAllAction.0"); //$NON-NLS-1$

    /**
     * @param viewer
     */
    public CollapseAllAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("CollapseAllAction.1")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.collapseall"; //$NON-NLS-1$
    }
