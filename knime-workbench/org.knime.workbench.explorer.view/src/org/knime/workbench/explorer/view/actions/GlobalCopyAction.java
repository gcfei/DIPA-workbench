...
public class GlobalCopyAction extends AbstractCopyMoveAction {
    ...
    public static final String ACTION_ID =
            "org.knime.workbench.explorer.action.copy"; //$NON-NLS-1$

    /**
     * @param viewer the viewer
     */
    public GlobalCopyAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("GlobalCopyAction.1"), false); //$NON-NLS-1$
    }
    ...
    public GlobalCopyAction(final ExplorerView view,
        ...
        super(view, Messages.getString("GlobalCopyAction.2"), sources, target, false); //$NON-NLS-1$
    }
