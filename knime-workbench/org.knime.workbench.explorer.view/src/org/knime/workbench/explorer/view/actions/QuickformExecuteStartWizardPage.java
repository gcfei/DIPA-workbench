...
public class QuickformExecuteStartWizardPage extends WizardPage {
    ...
    static final String PAGE_NAME = "QuickformExecuteStartWizardPage"; //$NON-NLS-1$
    ...
    QuickformExecuteStartWizardPage(final QuickformExecuteWizard wizard) {
        super(PAGE_NAME);
        setTitle(Messages.getString("QuickformExecuteStartWizardPage.2")); //$NON-NLS-1$
        setDescription(Messages.getString("QuickformExecuteStartWizardPage.3") //$NON-NLS-1$
                + Messages.getString("QuickformExecuteStartWizardPage.4") //$NON-NLS-1$
                + Messages.getString("QuickformExecuteStartWizardPage.5")); //$NON-NLS-1$
    ...
    public void createControl(final Composite parent) {
        ...
        if (wfm != null) {
            if (!wfm.getWorkflowVariables().isEmpty()) {
                ...
                group1.setText(Messages.getString("QuickformExecuteStartWizardPage.6")); //$NON-NLS-1$
            ...
            if (!wfm.getCredentialsStore().listNames().isEmpty()) {
                ...
                group2.setText(Messages.getString("QuickformExecuteStartWizardPage.7")); //$NON-NLS-1$
            ...
            if ((m_wfmVars == null) && (m_credDialog == null)) {
                ...
                l.setText(Messages.getString("QuickformExecuteStartWizardPage.8") //$NON-NLS-1$
                        + Messages.getString("QuickformExecuteStartWizardPage.9")); //$NON-NLS-1$
