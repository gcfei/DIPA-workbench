...
public class MergeRenameDialog extends Dialog {
    ...
    private String m_newName = ""; //$NON-NLS-1$
    ...
    protected void configureShell(final Shell newShell) {
        ...
        newShell.setText(Messages.getString("MergeRenameDialog.1")); //$NON-NLS-1$
    }
    ...
    private void createHeader(final Composite parent) {
        ...
        exec.setText(Messages.getString("MergeRenameDialog.2")); //$NON-NLS-1$
        ...
        if (m_canWriteDestination) {
            txt.setText(Messages.getString("MergeRenameDialog.3") + m_destination.getName() + Messages.getString("MergeRenameDialog.4") //$NON-NLS-1$ //$NON-NLS-2$
                + Messages.getString("MergeRenameDialog.5")); //$NON-NLS-1$
        } else {
            txt.setText(Messages.getString("MergeRenameDialog.6") + m_destination.getName() + Messages.getString("MergeRenameDialog.7") //$NON-NLS-1$ //$NON-NLS-2$
                + Messages.getString("MergeRenameDialog.8")); //$NON-NLS-1$
        }
    ...
    private void createTextPanel(final Composite parent) {
        ...
        m_mergeGUI.setText(Messages.getString("MergeRenameDialog.9")); //$NON-NLS-1$
        m_mergeGUI.setToolTipText(Messages.getString("MergeRenameDialog.10") //$NON-NLS-1$
            + Messages.getString("MergeRenameDialog.11")); //$NON-NLS-1$
        ...
        m_overwriteGUI.setText(Messages.getString("MergeRenameDialog.12")); //$NON-NLS-1$
        m_overwriteGUI.setToolTipText(Messages.getString("MergeRenameDialog.13") + Messages.getString("MergeRenameDialog.14")); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        if (!m_canWriteDestination) {
            ...
            m_mergeGUI.setToolTipText(Messages.getString("MergeRenameDialog.15") + Messages.getString("MergeRenameDialog.16")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        m_renameGUI.setText(Messages.getString("MergeRenameDialog.17")); //$NON-NLS-1$
    ...
    private void setSelectedAndValidate(final Button choice) {
        String errMsg = Messages.getString("MergeRenameDialog.19"); //$NON-NLS-1$
        ...
        try {
            if (m_renameGUI.getSelection()) {
                if (m_newName.isEmpty()) {
                    errMsg = Messages.getString("MergeRenameDialog.20"); //$NON-NLS-1$
                ...
                if (parent.getChild(m_newName).fetchInfo().exists()) {
                    errMsg = Messages.getString("MergeRenameDialog.21"); //$NON-NLS-1$
                    return;
                }
            }
            errMsg = null;
    ...
    private String getAlternativeName() {
        ...
        while (parent.getChild(name).fetchInfo().exists()) {
            name = m_destination.getName() + "(" + (++cnt) + ")"; //$NON-NLS-1$ //$NON-NLS-2$
        }
        return name;
    }
