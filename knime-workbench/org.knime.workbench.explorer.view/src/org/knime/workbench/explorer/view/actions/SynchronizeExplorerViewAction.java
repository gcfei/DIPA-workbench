...
public class SynchronizeExplorerViewAction extends ExplorerAction {
    private static final String TOOLTIP
            = Messages.getString("SynchronizeExplorerViewAction.0"); //$NON-NLS-1$
    ...
    public SynchronizeExplorerViewAction(final ExplorerView viewer,
        ...
        super(viewer, Messages.getString("SynchronizeExplorerViewAction.1")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.synchronize-view"; //$NON-NLS-1$
    }
    ...
    private AbstractExplorerFileStore resolveViaFilestore(final IEditorPart rootEditor) {
        ...
        if (editorInput instanceof FileStoreEditorInput) {
            ...
            if (uri.getPath().endsWith("/" + WorkflowPersistor.WORKFLOW_FILE)) { //$NON-NLS-1$
