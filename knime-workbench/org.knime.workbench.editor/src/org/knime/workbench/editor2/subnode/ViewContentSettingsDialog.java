...
public class ViewContentSettingsDialog extends TitleAreaDialog {
    ...
    public void create() {
        super.create();
        setTitle(Messages.ViewContentSettingsDialog_0 + m_viewSettings.getNodeID());
        setMessage(Messages.ViewContentSettingsDialog_1, IMessageProvider.NONE);
    }
    ...
    private void createResizeMethodCombo(final Composite container) {
        ...
        label.setText(Messages.ViewContentSettingsDialog_2);
    ...
    private void createAdditionalResizeFields(final Composite container) {
        ...
        resizeToleranceLabel.setText(Messages.ViewContentSettingsDialog_8);
    ...
    private void createDimensionFields(final Composite container) {
        ...
        minWidthLabel.setText(Messages.ViewContentSettingsDialog_9);
        ...
        maxWidthLabel.setText(Messages.ViewContentSettingsDialog_10);
        ...
        minHeightLabel.setText(Messages.ViewContentSettingsDialog_11);
        ...
        maxHeightLabel.setText(Messages.ViewContentSettingsDialog_12);
    ...
    private void fillFields() {
        ...
        m_resizeIntervalText.setText(resizeInterval == null ? Messages.ViewContentSettingsDialog_13 : resizeInterval.toString());
        Integer resizeTolerance = m_viewSettings.getResizeTolerance();
        m_resizeToleranceSpinner.setText(resizeTolerance == null ? Messages.ViewContentSettingsDialog_14 : resizeTolerance.toString());

        Integer minWidth = m_viewSettings.getMinWidth();
        m_minWidthText.setText(minWidth == null ? Messages.ViewContentSettingsDialog_15 : minWidth.toString());
        Integer maxWidth = m_viewSettings.getMaxWidth();
        m_maxWidthText.setText(maxWidth == null ? Messages.ViewContentSettingsDialog_16 : maxWidth.toString());
        Integer minHeight = m_viewSettings.getMinHeight();
        m_minHeightText.setText(minHeight == null ? Messages.ViewContentSettingsDialog_17 : minHeight.toString());
        Integer maxHeight = m_viewSettings.getMaxHeight();
        m_maxHeightText.setText(maxHeight == null ? Messages.ViewContentSettingsDialog_18 : maxHeight.toString());
    }
    ...
    private boolean saveViewSettings() {
        try {
            ...
            if (e instanceof NumberFormatException) {
                error = Messages.ViewContentSettingsDialog_19 + error;
            }
    ...
    protected void createButtonsForButtonBar(final Composite parent) {
        ...
        Button resetButton = createButton(parent, IDialogConstants.NO_ID, Messages.ViewContentSettingsDialog_20, false);
        resetButton.setImage(ImageRepository.getIconImage(KNIMEEditorPlugin.PLUGIN_ID, "icons/layout/reset.png"));
        resetButton.setToolTipText(Messages.ViewContentSettingsDialog_22);
