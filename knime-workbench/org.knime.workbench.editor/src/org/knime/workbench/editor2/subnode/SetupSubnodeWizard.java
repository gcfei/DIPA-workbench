...
public class SetupSubnodeWizard extends Wizard {
   ...
   public void addPages() {
       setWindowTitle(Messages.SetupSubnodeWizard_0);
       ...
       m_portsPage = new ConfigureMetaNodePortsPage(Messages.SetupSubnodeWizard_2);
  ...
  public boolean canFinish() {
    ...
    private boolean applyPortChanges() {
     ...
     // determine what has changed
        ...
        if (inPortChanges) {
            infoStr.append(Messages.SetupSubnodeWizard_3);
        }
        if (outPortChanges) {
            infoStr.append(Messages.SetupSubnodeWizard_4);
        }
        if (nameChange) {
            infoStr.append(Messages.SetupSubnodeWizard_5);
        }
        if (infoStr.length() == 0) {
            LOGGER.info(Messages.SetupSubnodeWizard_6);
            return true;
        }
        infoStr.insert(0, Messages.SetupSubnodeWizard_7);
        infoStr.append(Messages.SetupSubnodeWizard_8 + m_subNode.getID());
        LOGGER.info(infoStr);
