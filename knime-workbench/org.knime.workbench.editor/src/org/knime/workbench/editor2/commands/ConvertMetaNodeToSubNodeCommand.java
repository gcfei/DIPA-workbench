...
public class ConvertMetaNodeToSubNodeCommand extends AbstractKNIMECommand {
    ...
    public void execute() {
        try {
            ...
            String error = Messages.ConvertMetaNodeToSubNodeCommand_0 + e.getMessage();
            LOGGER.error(error, e);
            MessageDialog.openError(SWTUtilities.getActiveShell(), Messages.ConvertMetaNodeToSubNodeCommand_1, error);
        }
    }
