    ...
    public void execute() {
        ...
        for (final ConnectionContainer cc : m_connectionsToRemove) {
            try {
                ...
                LOGGER.error(Messages.UnlinkNodesCommand_0 + cc.getSource() + ":" + cc.getSourcePort() //$NON-NLS-2$
                    + Messages.UnlinkNodesCommand_2 + cc.getDest() + ":" + cc.getDestPort() + Messages.UnlinkNodesCommand_4 + e.getMessage(), e); //$NON-NLS-2$
            }
        }
    }
    ...
    public void undo() {
        ...
        for (final ConnectionContainer cc : m_connectionsToRemove) {
            try {
                ...
                LOGGER.error(Messages.UnlinkNodesCommand_5 + cc.getSource() + ":" + cc.getSourcePort() //$NON-NLS-2$
                    + Messages.UnlinkNodesCommand_7 + cc.getDest() + ":" + cc.getDestPort() + Messages.UnlinkNodesCommand_9 + e.getMessage(), e); //$NON-NLS-2$
            }
        }
    }
}
