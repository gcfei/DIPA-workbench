...
public class UpdateMetaNodeLinkCommand extends AbstractKNIMECommand {
    ...
    public void execute() {
        ...
        try {
            ...
            LOGGER.debug(Messages.UpdateMetaNodeLinkCommand_0, ex);
            MessageDialog.openWarning(SWTUtilities.getActiveShell(), Messages.UpdateMetaNodeLinkCommand_1,
                Messages.UpdateMetaNodeLinkCommand_2 + Messages.UpdateMetaNodeLinkCommand_3 + ex.getMessage());
            return;
        } finally {
    ...
    @Override
    public void undo() {
        LOGGER.debug(Messages.UpdateMetaNodeLinkCommand_4
                + m_newIDs.size() + Messages.UpdateMetaNodeLinkCommand_5);
        WorkflowManager hostWFM = getHostWFM();
