...
public class ShiftConnectionCommand extends AbstractKNIMECommand {
    ...
    public void execute() {
        ...
        try {
            ...
            LOGGER.error(Messages.ShiftConnectionCommand_0
                    + Messages.ShiftConnectionCommand_1, e);
            getHostWFM().addConnection(existingConn.getSource(),
    ...
    public void undo() {
        ...
        try {
            ...
            LOGGER.error(Messages.ShiftConnectionCommand_2
                    + Messages.ShiftConnectionCommand_3, e);
            getHostWFM().addConnection(newConn.getSource(),
