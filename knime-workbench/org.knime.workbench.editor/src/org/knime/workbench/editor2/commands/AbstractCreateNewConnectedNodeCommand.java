...
public abstract class AbstractCreateNewConnectedNodeCommand extends
    ...
    private void autoConnectNewNode() {
        ...
        if (matchingPorts.size() == 0) {
            LOGGER.info(Messages.AbstractCreateNewConnectedNodeCommand_0 + m_newNode + "): " //$NON-NLS-2$
                    + Messages.AbstractCreateNewConnectedNodeCommand_2
        ...
        for (Map.Entry<Integer, Integer> entry : matchingPorts.entrySet()) {
            ...
            LOGGER.info(Messages.AbstractCreateNewConnectedNodeCommand_3 + m_newNode
                    + Messages.AbstractCreateNewConnectedNodeCommand_4 + rightPort + Messages.AbstractCreateNewConnectedNodeCommand_5
                    + sourceNode + Messages.AbstractCreateNewConnectedNodeCommand_6 + leftPort);
            try {
                ...
                }, hostWFM, Messages.AbstractCreateNewConnectedNodeCommand_7);
                ...
                String msg =
                        Messages.AbstractCreateNewConnectedNodeCommand_8 + from + Messages.AbstractCreateNewConnectedNodeCommand_9
                                + leftPort + Messages.AbstractCreateNewConnectedNodeCommand_10 + to + Messages.AbstractCreateNewConnectedNodeCommand_11 + rightPort
    ...
    public void undo() {
        try {
            ...
            }, getHostWFMUI(), Messages.AbstractCreateNewConnectedNodeCommand_13);
        } catch (Exception e) {
            String msg =
                    Messages.AbstractCreateNewConnectedNodeCommand_14 + m_newNode + Messages.AbstractCreateNewConnectedNodeCommand_15
                            + e.getMessage();
            LOGGER.error(msg);
            MessageDialog.openInformation(SWTUtilities.getActiveShell(), Messages.AbstractCreateNewConnectedNodeCommand_16, msg);
        }
    }
}
