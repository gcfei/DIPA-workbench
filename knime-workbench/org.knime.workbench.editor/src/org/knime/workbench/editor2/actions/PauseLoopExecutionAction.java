...
public class PauseLoopExecutionAction extends AbstractNodeAction {
     ...
     */
    public static final String ID = "knime.action.pauseexecution"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.PauseLoopExecutionAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/pause.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/pause_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.PauseLoopExecutionAction_4;
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        LOGGER.debug(Messages.PauseLoopExecutionAction_5
                + nodeParts.length + Messages.PauseLoopExecutionAction_6);
