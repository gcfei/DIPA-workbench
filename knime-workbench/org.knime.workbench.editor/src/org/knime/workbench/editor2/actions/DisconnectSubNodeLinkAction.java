...
public class DisconnectSubNodeLinkAction extends AbstractNodeAction {
    ...
    /** Action ID. */
    public static final String ID = "knime.action.sub_node_disconnect_link"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.DisconnectSubNodeLinkAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.DisconnectSubNodeLinkAction_2;
    }
