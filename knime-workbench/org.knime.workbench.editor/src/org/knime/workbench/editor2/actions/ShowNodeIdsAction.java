...
public class ShowNodeIdsAction extends AbstractClipboardAction {
    ...
    public static final String ID = "knime.action.append_node_id"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.ShowNodeIdsAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/showNodeIds.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/showNodeIds_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.ShowNodeIdsAction_4;
    }
