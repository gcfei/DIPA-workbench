...
public class DisconnectMetaNodeLinkAction extends AbstractNodeAction {
    ...
    /** Action ID. */
    public static final String ID = "knime.action.meta_node_disconnect_link"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.DisconnectMetaNodeLinkAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.DisconnectMetaNodeLinkAction_2
            + Messages.DisconnectMetaNodeLinkAction_3;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/meta/metanode_link_disconnect.png"); //$NON-NLS-1$
    }
