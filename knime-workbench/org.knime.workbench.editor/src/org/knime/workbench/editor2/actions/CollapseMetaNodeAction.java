...
public class CollapseMetaNodeAction extends AbstractNodeAction {
     ...
     */
    public static final String ID = "knime.action.collapsemetanode"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.CollapseMetaNodeAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/meta/metanode_add.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.CollapseMetaNodeAction_3;
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        throw new IllegalStateException(Messages.CollapseMetaNodeAction_4);
    }
