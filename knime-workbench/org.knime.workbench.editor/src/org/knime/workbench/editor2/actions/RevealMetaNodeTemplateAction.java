...
public class RevealMetaNodeTemplateAction extends AbstractNodeAction {
    /** Action ID. */
    public static final String ID = "knime.action.meta_node_reveal_template"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.RevealMetaNodeTemplateAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.RevealMetaNodeTemplateAction_2;
    }
