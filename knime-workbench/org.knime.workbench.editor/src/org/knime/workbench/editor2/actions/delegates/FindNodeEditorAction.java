    ...
    private synchronized static void fixFindMenuItemIfNotYetDone() {
        ...
        if (ww != null) {
            ...
            for (final MenuItem mi : m.getItems()) {
                if (mi.getText().equals("Node")) { //$NON-NLS-1$
                    nodeMenuItem = mi;
                    break;
                }
            }
                ...
                NODE_MENU.addMenuListener(new MenuListener() {
                    ...
                    public void menuShown(final MenuEvent e) {
                        ...
                        for (final MenuItem mi : NODE_MENU.getItems()) {
                            if (mi.getText().equals("Find Node...")) { //$NON-NLS-1$
                                findMenuItem = mi;
                                break;
                            }
                        }
                        ...
                        if (findMenuItem != null) {
                            ...
                            if (!Platform.getOS().equals(Platform.OS_MACOSX)) {
                                findMenuItem.setText(Messages.FindNodeEditorAction_2);
                            }

                            FIND_MENU_ITEM_IS_FIXED.set(true);

                            LOGGER.debug(Messages.FindNodeEditorAction_3 + findMenuItem);
                        }
                    }
                });
            }
