...
public class LockMetaNodeAction extends AbstractNodeAction {
    ...
    /** Action ID. */
    public static final String ID = "knime.action.meta_node_lock"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.LockMetaNodeAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.LockMetaNodeAction_2;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/meta/metanode_lock.png"); //$NON-NLS-1$
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodes) {
        ...
        try {
            ...
            String msg = Messages.LockMetaNodeAction_4 + e.getMessage();
            LOGGER.error(msg, e);
            MessageDialog.openError(shell, Messages.LockMetaNodeAction_5, msg);
        }
    }
