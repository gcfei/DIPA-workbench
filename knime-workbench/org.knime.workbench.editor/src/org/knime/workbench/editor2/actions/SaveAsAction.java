...
public class SaveAsAction extends AbstractNodeAction {
    ...
    @Override
    protected void init() {
        setText(Messages.SaveAsAction_0);
        setToolTipText(Messages.SaveAsAction_1);
    }
    ...
    public String getText() {
        return Messages.SaveAsAction_2; // not actually shown anywhere
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/dipa.png"); // not shown anywhere //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.SaveAsAction_4;
    }
