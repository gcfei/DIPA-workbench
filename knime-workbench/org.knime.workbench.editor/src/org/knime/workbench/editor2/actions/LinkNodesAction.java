...
public class LinkNodesAction extends AbstractLinkNodesAction {
    ...
    public static final String ID = "knime.actions.linknodes"; //$NON-NLS-1$
    /** org.eclipse.ui.commands command ID for this action. **/
    private static final String COMMAND_ID = "knime.commands.linknodes"; //$NON-NLS-1$
   ...
   protected static boolean nodesOverlapInXDomain(final NodeContainerUI node1, final NodeContainerUI node2) {
    ...
    public String getText() {
        return Messages.LinkNodesAction_2 + getHotkey(COMMAND_ID);
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/link_nodes.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/link_nodes_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.LinkNodesAction_5;
    }
    ...
    protected boolean portAlreadyHasConnection(final NodeContainerUI node, final int port, final boolean inport,
        ...
        if (existingPlan == null) {
            throw new IllegalArgumentException(Messages.LinkNodesAction_6);
        }
        if (existingConnections == null) {
            throw new IllegalArgumentException(Messages.LinkNodesAction_7);
        }
    ...
    protected ScreenedSelectionSet screenNodeSelection(final ConnectableEditPart[] connectables) {
        ...
        try {
            ...
            LOGGER.warn(Messages.LinkNodesAction_8, e);
    ...
    public static class PlannedConnection {
        ...
        public String toString() {
            return m_sourceNode.getNodeContainer().getNameWithID() + ":" + m_sourceOutportIndex + " -> " //$NON-NLS-1$ //$NON-NLS-2$
                + m_destinationNode.getNodeContainer().getNameWithID() + ":" + m_destinationInportIndex //$NON-NLS-1$
                + (m_detachDestinationFirst ? " [DETACH]" : ""); //$NON-NLS-1$ //$NON-NLS-2$
        }
    }
