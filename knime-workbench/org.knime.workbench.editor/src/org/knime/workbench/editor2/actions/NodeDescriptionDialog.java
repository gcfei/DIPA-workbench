...
public class NodeDescriptionDialog extends Dialog {
    ...
    protected void configureShell(final Shell newShell) {
        ...
        Image img = KNIMEUIPlugin.getDefault().getImageRegistry().get("knime"); //$NON-NLS-1$
        ...
        idLabel.setText(Messages.NodeDescriptionDialog_1);
        ...
        descriptionLabel.setText(Messages.NodeDescriptionDialog_2);
        // Description value
        ...
        if (m_initDescription == null) {
            m_descriptionField.setText(""); //$NON-NLS-1$
        } else {
