...
public class ToggleEditorModeAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.editor.toggleEditorMode"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.ToggleEditorModeAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.ToggleEditorModeAction_2;
    }
    ...
    public void runInSWT() {
        ...
        if (we != null) {
            ...
            LOGGER.error(Messages.ToggleEditorModeAction_3);
        }
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        throw new IllegalStateException(Messages.ToggleEditorModeAction_4);
    }
}
