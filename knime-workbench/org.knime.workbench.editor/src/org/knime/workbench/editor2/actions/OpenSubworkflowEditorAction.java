...
public class OpenSubworkflowEditorAction extends Action {
    ...
    private static final String ID = "knime.open.subworkflow.editor"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.OpenSubworkflowEditorAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.OpenSubworkflowEditorAction_2;
    }
