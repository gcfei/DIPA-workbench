...
public class BorderStyleDialog extends Dialog {
    ...
    /**
     * @param parentShell the parent shell which will host the display of this dialog
     * @param defColor the current color
     * @param defSize the current size
     */
    ...
    private void createColorSelector(final Composite parent) {
        ...
        msg.setText(Messages.BorderStyleDialog_0);
    ...
    private void createSizeSelector(final Composite parent) {
        ...
        Label msg = new Label(panel, SWT.LEFT);
        msg.setText(Messages.BorderStyleDialog_1);
        msg.setLayoutData(gData);
    ...
    protected void createHeader(final Composite parent) {
        ...
        exec.setText(Messages.BorderStyleDialog_2);
        ...
        txt.setText(Messages.BorderStyleDialog_3);
