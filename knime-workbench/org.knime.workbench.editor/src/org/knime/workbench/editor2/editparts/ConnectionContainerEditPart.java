...
//    }
    ...
    public Command getBendpointAdaptionCommand(final Request request) {
        assert (request instanceof ChangeBoundsRequest) : Messages.ConnectionContainerEditPart_0 + request.getClass();
...
//    }
    ...
    protected void refreshVisuals() {
        ...
        LOGGER.debug(Messages.ConnectionContainerEditPart_1 + getModel());
        ConnectionUIInformation ei = null;
        ei = getModel().getUIInfo();
        LOGGER.debug(Messages.ConnectionContainerEditPart_2 + ei);
