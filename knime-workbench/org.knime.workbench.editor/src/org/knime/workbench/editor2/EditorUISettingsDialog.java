...
public class EditorUISettingsDialog extends Dialog {
    ...
    private static final ImageDescriptor IMG_PERMS = AbstractUIPlugin.imageDescriptorFromPlugin(
            KNIMEEditorPlugin.PLUGIN_ID, "icons/editor_UI_settings_55.png"); //$NON-NLS-1$
    ...
    private void setValues() {
        ...
        m_xGrid.setText("" + m_settings.getGridX()); //$NON-NLS-1$
        m_yGrid.setText("" + m_settings.getGridY()); //$NON-NLS-1$
        m_connectionWidth.setText("" + m_settings.getConnectionLineWidth()); //$NON-NLS-1$
        settingsChanged();
    }
    ...
    protected void configureShell(final Shell newShell) {
        ...
        newShell.setText(Messages.EditorUISettingsDialog_4);
    }
    ...
    private void createHeader(final Composite parent) {
        ...
        exec.setText(Messages.EditorUISettingsDialog_5);
        ...
        txt.setText(
            Messages.EditorUISettingsDialog_6 + Messages.EditorUISettingsDialog_7
                + Messages.EditorUISettingsDialog_8
                + Messages.EditorUISettingsDialog_9);
    ...
    private void createEnablePanel(final Composite parent) {
        ...
        border.setText(Messages.EditorUISettingsDialog_10);
        m_snapToGrid = new Button(border, SWT.CHECK);
        m_snapToGrid.setText(Messages.EditorUISettingsDialog_11);
        ...
        m_showGrid.setText(Messages.EditorUISettingsDialog_12);
    ...
    private void createGridPanel(final Composite parent) {
        ...
        border.setText(Messages.EditorUISettingsDialog_13);
        ...
        h.setText(Messages.EditorUISettingsDialog_14);
        h.setToolTipText(Messages.EditorUISettingsDialog_15 + WorkflowEditor.getPrefGridXSize());
        ...
        m_xGrid.setToolTipText(Messages.EditorUISettingsDialog_16 + WorkflowEditor.getPrefGridXSize());
        ...
        v.setText(Messages.EditorUISettingsDialog_17);
        v.setToolTipText(Messages.EditorUISettingsDialog_18 + WorkflowEditor.getPrefGridYSize());
        ...
        m_yGrid.setToolTipText(Messages.EditorUISettingsDialog_19 + WorkflowEditor.getPrefGridYSize());
    ...
    private void createNodeConnectionsPanel(final Composite parent) {
        ...
        border.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
        border.setLayout(new GridLayout(2, true));
        border.setText(Messages.EditorUISettingsDialog_20);
        m_curvedConnections = new Button(border, SWT.CHECK);
        m_curvedConnections.setText(Messages.EditorUISettingsDialog_21);
        ...
        v.setText(Messages.EditorUISettingsDialog_22);
        v.setToolTipText(Messages.EditorUISettingsDialog_23 + WorkflowEditor.getPrefConnectionLineWidth());
        ...
        m_connectionWidth.setItems(new String[] {"1", "2", "3"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        m_connectionWidth.setToolTipText(Messages.EditorUISettingsDialog_27 + WorkflowEditor.getPrefConnectionLineWidth());
    ...
    private void settingsChanged() {
        ...
        if (x.isEmpty()) {
            setError(Messages.EditorUISettingsDialog_28);
            return;
        }
        try {
            int xInt = Integer.parseInt(x);
            if (xInt <= 0) {
                setError(Messages.EditorUISettingsDialog_29);
            ...
            setError(Messages.EditorUISettingsDialog_30);
            m_xGrid.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_RED));
            return;
        }
        ...
        if (y.isEmpty()) {
            setError(Messages.EditorUISettingsDialog_31);
            return;
        }
        try {
            int yInt = Integer.parseInt(y);
            if (yInt <= 0) {
                setError(Messages.EditorUISettingsDialog_32);
            ...
            setError(Messages.EditorUISettingsDialog_33);
            m_yGrid.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_RED));
            return;
        }
        setError(""); //$NON-NLS-1$
