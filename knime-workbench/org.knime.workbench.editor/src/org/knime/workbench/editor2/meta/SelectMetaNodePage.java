...
public class SelectMetaNodePage extends WizardPage {
    ...
    private static final String TITLE = Messages.SelectMetaNodePage_0;
    private static final String DESCRIPTION = Messages.SelectMetaNodePage_1
        + Messages.SelectMetaNodePage_2
        + Messages.SelectMetaNodePage_3;

    static final String ZERO_ONE = "0:1"; //$NON-NLS-1$
    static final String ONE_ONE = "1:1"; //$NON-NLS-1$
    static final String ONE_TWO = "1:2"; //$NON-NLS-1$
    static final String TWO_ONE = "2:1"; //$NON-NLS-1$
    static final String TWO_TWO = "2:2"; //$NON-NLS-1$
    ...
    public void createControl(final Composite parent) {
        ...
        btnZeroOne.setImage(ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
                "/icons/meta/meta_0_1_inactive.png")); //$NON-NLS-1$
        ...
        m_activeIconMap.put(btnZeroOne, ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
            "/icons/meta/meta_0_1.png")); //$NON-NLS-1$
        ...
        btnOneOne.setImage(ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
                "/icons/meta/meta_1_1_inactive.png")); //$NON-NLS-1$
        ...
        m_activeIconMap.put(btnOneOne, ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
                "/icons/meta/meta_1_1.png")); //$NON-NLS-1$
        ...
        btnOneTwo.setImage(ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
                "/icons/meta/meta_1_2_inactive.png")); //$NON-NLS-1$
        m_inactiveIconMap.put(btnOneTwo, ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID,
                "/icons/meta/meta_1_2_inactive.png")); //$NON-NLS-1$
        m_activeIconMap.put(btnOneTwo,
                ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/meta/meta_1_2.png")); //$NON-NLS-1$
