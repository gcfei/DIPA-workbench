...
public final class WorkflowManagerTransfer extends SimpleObjectTransfer {
    private static final String TYPE_NAME
            = "workflow-manager-transfer-format" + System.currentTimeMillis(); //$NON-NLS-1$
        ...
        if (obj instanceof List) {
           for (Object item : (List)obj) {
               if (!(item instanceof WorkflowManager)) {
                   throw new IllegalArgumentException(Messages.WorkflowManagerTransfer_1
                           + Messages.WorkflowManagerTransfer_2);
               }
           }
           super.setObject(obj);
        } else {
            throw new IllegalArgumentException(Messages.WorkflowManagerTransfer_3
                    + Messages.WorkflowManagerTransfer_4);
        }
    }
