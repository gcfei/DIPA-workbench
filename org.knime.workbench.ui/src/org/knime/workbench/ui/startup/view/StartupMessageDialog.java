            ...
            public void handleEvent(final Event event) {
                try {
                    ...
                    NodeLogger.getLogger(StartupMessageDialog.this.getClass()).error(
                        Messages.StartupMessageDialog_4 + event.text + Messages.StartupMessageDialog_5 + ex.getMessage(), ex);
                }
            }
        });
