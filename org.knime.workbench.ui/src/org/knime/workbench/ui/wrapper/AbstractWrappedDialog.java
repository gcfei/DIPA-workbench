...
public abstract class AbstractWrappedDialog extends Dialog {
    ...
    protected void finishDialogCreation() {
        if (Platform.OS_MACOSX.equals(Platform.getOS()) || Platform.OS_LINUX.equals(Platform.getOS())) {
            if (m_awtKeyListener == null) {
                throw new IllegalStateException(Messages.AbstractWrappedDialog_0);
            }

            if (m_swtKeyListener == null) {
                throw new IllegalStateException(Messages.AbstractWrappedDialog_1);
            }
    ...
    protected void showErrorMessage(final String message) {
        ...
        mb.setText(Messages.AbstractWrappedDialog_2);
        mb.setMessage(message != null ? message : Messages.AbstractWrappedDialog_3);
        mb.open();
    }
    ...
    protected void showWarningMessage(final String message) {
        ...
        mb.setText(Messages.AbstractWrappedDialog_4);
        mb.setMessage(message != null ? message : Messages.AbstractWrappedDialog_5);
        mb.open();
    }
    ...
    protected void informNothingChanged() {
        ...
        mb.setText(Messages.AbstractWrappedDialog_6);
        mb.setMessage(Messages.AbstractWrappedDialog_7);
        mb.open();
    }
}
