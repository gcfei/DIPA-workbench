...
public class CredentialVariablesDialog extends Dialog {
   ...
   public CredentialVariablesDialog(final Shell shell,
    ...
    public Control createDialogArea(final Composite parent,
        ...
        parent.getShell().setText(Messages.CredentialVariablesDialog_0);
        Composite composite = new Composite(parent, SWT.NONE);
        if (m_workflowName != null) {
            Label label = new Label(composite, SWT.NONE);
            label.setText(Messages.CredentialVariablesDialog_1
                + m_workflowName + "'."); //$NON-NLS-1$
        }
        ...
        if (!hideButtons) {
            ...
            m_addVarBtn.setText(Messages.CredentialVariablesDialog_3);
            ...
            m_editVarBtn.setText(Messages.CredentialVariablesDialog_4);
            ...
            m_editVarBtn.addSelectionListener(new SelectionListener() {
                ...
                public void widgetSelected(final SelectionEvent arg0) {
                    int selectionIdx = m_table.getViewer().getTable()
                        .getSelectionIndex();
                    if (selectionIdx < 0) {
                        MessageDialog.openWarning(getShell(), Messages.CredentialVariablesDialog_5,
                            Messages.CredentialVariablesDialog_6);
                        return;
                    }
            ...
            m_removeVarBtn.setText(Messages.CredentialVariablesDialog_7);
            ...
            m_removeVarBtn.addSelectionListener(new SelectionListener() {
                ...
                public void widgetSelected(final SelectionEvent arg0) {
                    ...
                    if (idx < 0) {
                        MessageDialog.openWarning(getShell(), Messages.CredentialVariablesDialog_8,
                                Messages.CredentialVariablesDialog_9);
                        return;
                    }
                    Credentials cred =
    ...
    private void addCredential() {
        ...
        if (!m_table.add(var)) {
            MessageDialog.openWarning(getShell(), Messages.CredentialVariablesDialog_10,
                    Messages.CredentialVariablesDialog_11
                    + Messages.CredentialVariablesDialog_12);
        } else {
            m_table.getViewer().refresh();
        }
        getShell().forceFocus();
