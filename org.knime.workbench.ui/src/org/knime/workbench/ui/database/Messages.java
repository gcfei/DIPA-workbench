...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "org.knime.workbench.ui.database.messages"; //$NON-NLS-1$

    public static String DatabaseDriverListEditor_1;

    public static String DatabaseDriverListEditor_2;

    public static String DatabaseDriverListEditor_5;

    public static String DatabaseDriverListEditor_6;
