...
public class CommunityTripleProvider extends AbstractFileDownloadTripleProvider {
    ...
    public CommunityTripleProvider() {
        super("https://update.knime.com/community_recommendations.json", "community_recommendations.json"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public String getName() {
        return Messages.CommunityTripleProvider_2;
    }
    ...
    public String getDescription() {
        return Messages.CommunityTripleProvider_3;
    }
