...
public class CreateNodeCommand extends AbstractKNIMECommand {
    ...
    /**
     * We can execute, if all components were 'non-null' in the constructor. {@inheritDoc}
     */
    @Override
    ...
    public void execute() {
        ...
        try {
            ...
            }, hostWFM, Messages.CreateNodeCommand_1);
            ...
            LOGGER.debug(Messages.CreateNodeCommand_2, t);
            MessageBox mb = new MessageBox(SWTUtilities.getActiveShell(), SWT.ICON_WARNING | SWT.OK);
            mb.setText(Messages.CreateNodeCommand_3);
            mb.setMessage(Messages.CreateNodeCommand_4
                    + Messages.CreateNodeCommand_5 + t.getMessage());
            mb.open();
            return;
        }
    }
    ...
    @Override
    public void undo() {
        LOGGER.debug(Messages.CreateNodeCommand_6 + m_container.getID());
        if (canUndo()) {
            try {
                ...
                }, getHostWFMUI(), Messages.CreateNodeCommand_7);
            } catch (OperationNotAllowedException e) {
                //should never happen
            }
        } else {
            MessageDialog.openInformation(SWTUtilities.getActiveShell(),
                    Messages.CreateNodeCommand_8, Messages.CreateNodeCommand_9
                    + m_container.getNameWithID()
                    + Messages.CreateNodeCommand_10);
        }
    }
}
