...
public final class PasteFromWorkflowPersistorCommand
    ...
    public void execute() {
        ...
        }, manager, Messages.PasteFromWorkflowPersistorCommand_0);
    }
    ...
    public void undo() {
        ...
        try {
            AsyncUtil.wfmAsyncSwitchRethrow(wfm -> {
                ...
                return null;
            }, wfm -> wfm.removeAsync(nodeIDs, connIDs, annoIDs), manager, Messages.PasteFromWorkflowPersistorCommand_1);
        } catch (OperationNotAllowedException e) {
            openDialog(Messages.PasteFromWorkflowPersistorCommand_2, Messages.PasteFromWorkflowPersistorCommand_3 + e.getMessage());
        }
    }
