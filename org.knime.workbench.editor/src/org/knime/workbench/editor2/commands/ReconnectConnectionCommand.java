    ...
    public void execute() {
        ...
        if (m_confirm && (oldExecuted || newExecuted)) {
            ...
            StringBuffer message = new StringBuffer(
                    Messages.ReconnectConnectionCommand_0);
            if (oldExecuted || newExecuted) {
                message.append(Messages.ReconnectConnectionCommand_1);
                if (oldExecuted) {
                    message.append(Messages.ReconnectConnectionCommand_2);
                }
                if (oldExecuted && newExecuted) {
                    message.append(Messages.ReconnectConnectionCommand_3);
                }
                if (newExecuted) {
                    message.append(Messages.ReconnectConnectionCommand_4);
                }
                message.append('!');
            }
