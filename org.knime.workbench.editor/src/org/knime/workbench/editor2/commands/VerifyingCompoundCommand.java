        ...
        try {
            ...
            if (!store.contains(PreferenceConstants.P_CONFIRM_DELETE)
                ...
                MessageDialogWithToggle dialog =
                    MessageDialogWithToggle.openOkCancelConfirm(SWTUtilities.getActiveShell(), Messages.VerifyingCompoundCommand_0,
                        m_dialogDisplayText, Messages.VerifyingCompoundCommand_1, false, null, null);
            ...
            LOGGER.debug(Messages.VerifyingCompoundCommand_2 + size() + Messages.VerifyingCompoundCommand_3);
            super.execute();
        } finally {
            for (NodeContainerEditPart nodePart : m_nodeParts) {
