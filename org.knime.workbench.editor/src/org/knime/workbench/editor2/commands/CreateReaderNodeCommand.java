...
public class CreateReaderNodeCommand extends AbstractKNIMECommand {
    ...
    public void execute() {
        ...
        try {
            ...
            LOGGER.debug(Messages.CreateReaderNodeCommand_0, t);
            MessageBox mb = new MessageBox(SWTUtilities.getActiveShell(), SWT.ICON_WARNING | SWT.OK);
            mb.setText(Messages.CreateReaderNodeCommand_1);
            mb.setMessage(Messages.CreateReaderNodeCommand_2 + t.getMessage());
            mb.open();
        }
    }
    ...
    @Override
    public void undo() {
        LOGGER.debug(Messages.CreateReaderNodeCommand_3 + m_container.getID());
        if (canUndo()) {
            ...
            MessageDialog.openInformation(SWTUtilities.getActiveShell(), Messages.CreateReaderNodeCommand_4,
                Messages.CreateReaderNodeCommand_5 + m_container.getNameWithID() + Messages.CreateReaderNodeCommand_6);
        }
    }
}
