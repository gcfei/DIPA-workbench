...
public class CreateConnectionCommand extends AbstractKNIMECommand {
    ...
    public static final String REPLACE_CONNECTION_MESSAGE =
        Messages.CreateConnectionCommand_0;
    ...
    public void execute() {
        ...
        try {
            ...
            LOGGER.debug(Messages.CreateConnectionCommand_1
                    + m_sourceNode.getNodeContainer().getID() + " " //$NON-NLS-1$
                    + m_sourcePortID + Messages.CreateConnectionCommand_3
                    + m_targetNode.getNodeContainer().getID()
                    + " " + m_targetPortID); //$NON-NLS-1$
            ...
            MessageDialog.openError(SWTUtilities.getActiveShell(),
                    ...
                    Messages.CreateConnectionCommand_6
                    + Messages.CreateConnectionCommand_7 + e.getMessage());
    ...
    public static MessageDialogWithToggle openReconnectConfirmDialog(final boolean confirm, final String question) {
        ...
        return MessageDialogWithToggle.openYesNoQuestion(SWTUtilities.getActiveShell(), Messages.CreateConnectionCommand_8,
            questionText, Messages.CreateConnectionCommand_9, !confirm,
    ...
    public void undo() {
        ...
        try {
            ...
            MessageDialog.openError(SWTUtilities.getActiveShell(),
                Messages.CreateConnectionCommand_10,
                Messages.CreateConnectionCommand_11
                + Messages.CreateConnectionCommand_12 + e.getMessage());
        }
    }
    ...
    private static void removeConnection(final WorkflowManagerUI wfm, final ConnectionContainerUI cc)
        ...
        wfmAsyncSwitchRethrow(wm -> {
            ...
            return null;
        }, wm -> wm.removeAsync(null, connId, null), wfm, Messages.CreateConnectionCommand_13);
    }
    ...
    private static ConnectionContainerUI createConnection(final WorkflowManagerUI wfm, final NodeID source,
        ...
        return wfmAsyncSwitchRethrow(wm -> wm.addConnection(source, sourcePort, dest, destPort, bendpoints),
            ...
            Messages.CreateConnectionCommand_14);
    }
}
