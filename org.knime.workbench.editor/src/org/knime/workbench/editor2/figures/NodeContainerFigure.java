...
public class NodeContainerFigure extends RectangleFigure implements EditorModeParticipant {
    ...
    /** Red traffic light. */
    public static final Image RED = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/ampel_red.png"); //$NON-NLS-1$
    /** Ghostly form of the red traffic light. */
    public static final Image RED_GHOSTLY = makeImageGhostly(RED);

    /** Yellow traffic light. */
    public static final Image YELLOW = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/ampel_yellow.png"); //$NON-NLS-1$
    /** Ghostly form of the yello traffic light. */
    public static final Image YELLOW_GHOSTLY = makeImageGhostly(YELLOW);

    /** Green traffic light. */
    public static final Image GREEN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/ampel_green.png"); //$NON-NLS-1$
    ...
    public static final Image INACTIVE = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/ampel_inactive.png"); //$NON-NLS-1$
    /** Ghostly form of the inactive traffic light. */
    public static final Image INACTIVE_GHOSTLY = makeImageGhostly(INACTIVE);

    /** Info sign. */
    public static final Image INFO_SIGN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/roundInfo.jpg"); //$NON-NLS-1$
    /** Ghostly form of the info sign. */
    public static final Image INFO_SIGN_GHOSTLY = makeImageGhostly(INFO_SIGN);

    /** Warning sign. */
    public static final Image WARNING_SIGN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/warning.gif"); //$NON-NLS-1$
    /** Ghostly form of the warning sign. */
    public static final Image WARNING_SIGN_GHOSTLY = makeImageGhostly(WARNING_SIGN);

    /** Error sign. */
    public static final Image ERROR_SIGN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/error.png"); //$NON-NLS-1$
    /** Ghostly form of the error sign. */
    public static final Image ERROR_SIGN_GHOSTLY = makeImageGhostly(ERROR_SIGN);

    /** Delete sign. */
    public static final Image DELETE_SIGN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/delete.png"); //$NON-NLS-1$

    /** Loop End Node extra icon: In Progress. */
    public static final Image LOOP_IN_PROGRESS_SIGN =
        ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/loop_in_progress.png"); //$NON-NLS-1$
    ...
    public static final Image LOOP_DONE_SIGN =
        ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/loop_done.png"); //$NON-NLS-1$
    ...
    public static final Image LOOP_NO_STATUS =
        ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/loop_nostatus.png"); //$NON-NLS-1$
    ...
    /** Replace-node sign. */
    public static final Image REPLACE_SIGN = ImageRepository.getUnscaledImage(EDITOR_PLUGIN_ID, "icons/replace-node.png"); //$NON-NLS-1$
    ...
    public NodeContainerFigure(final ProgressFigure progressFigure) {
        ...
        m_symbolTooltip = new NewToolTipFigure(""); //$NON-NLS-1$
    ...
    private static String wrapText(final String text) {
        ...
        if (text.trim().indexOf(" ") < 0) { //$NON-NLS-1$
            return text.trim();
        }
    ...
    public void setCustomDescription(final String description) {
        if (description == null || description.trim().equals("")) { //$NON-NLS-1$
            m_symbolTooltip.setText(""); //$NON-NLS-1$
    ...
    private void setProgressBar(final ProgressMode mode) {
        ...
        case EXECUTING:
            ...
            m_progressFigure.setStateMessage(Messages.NodeContainerFigure_20);
        ...
        case QUEUED:
            ...
            m_progressFigure.setStateMessage(Messages.NodeContainerFigure_21);
            break;
        case PAUSED:
            m_progressFigure.setProgressMode(ProgressMode.PAUSED);
            m_progressFigure.setStateMessage(Messages.NodeContainerFigure_22);
            break;
        default:
            throw new AssertionError(Messages.NodeContainerFigure_23 + mode);
        }
    }
    ...
    public void setMessage(final NodeMessage msg) {
        ...
        if (msg == null || msg.getMessageType() == null) {
            NodeLogger.getLogger(NodeContainerFigure.class).warn(Messages.NodeContainerFigure_24);
        } else {
            switch (msg.getMessageType()) {
                ...
                case ERROR:
                    ...
                    break;
                default:
                    throw new AssertionError(Messages.NodeContainerFigure_25 + msg.getMessageType());
            }
        }
    ...
    protected class SymbolFigure extends GhostlySupportingFigure {
        ...
        public void setModifiablePortIcon(final NodeContainerEditPart nodeContainerEditPart) {
            if (m_modifiablePortLabel == null) {
                ...
                m_modifiablePortLabel.setToolTip(new NewToolTipFigure(Messages.NodeContainerFigure_26));
        ...
        private Image getBackgroundImage() {
            ...
            if (dnt == null) {
                LOGGER.warn(Messages.NodeContainerFigure_27 + m_nodeType);
    ...
    private class InfoWarnErrorPanel extends Figure {
        ...
        public void setWarning(final String message) {
            ...
            if (message != null && !message.trim().equals("")) { //$NON-NLS-1$
                ...
                m_warningFigure.setToolTip(Messages.NodeContainerFigure_29,
        ...
        public void setError(final String message) {
            ...
            if (message != null && !message.trim().equals("")) { //$NON-NLS-1$
                ...
                m_errorFigure.setToolTip(Messages.NodeContainerFigure_31,
    ...
    private class StatusFigure extends GhostlySupportingFigure {
        ...
        @Override
        void setIcon(final Image icon) {
            throw new IllegalStateException(Messages.NodeContainerFigure_32);
        }
    ...
    private class InfoWarnErrorFigure extends GhostlySupportingFigure {
        ...
        @Override
        void setIcon(final Image icon) {
            throw new IllegalStateException(Messages.NodeContainerFigure_33);
        }
    ...
    private static class ModifiablePortMouseTracker implements MouseListener, MouseMotionListener {
        private static final Image PORT_ICON =
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "icons/node/add_port_flat.png"); //$NON-NLS-1$
        private static final Image TRANSPARENT_ICON =
                ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "icons/node/add_port_flat_transparent.png"); //$NON-NLS-1$
        ...
        private static void fillMenu(final NodeContainerEditPart nodeContainerEditPart, final Menu popUpMenu) {
            ...
            if (portCreator.hasActions()) {
                addActions(popUpMenu, portCreator.getAddPortActions(), Messages.NodeContainerFigure_36);
                addActions(popUpMenu, portCreator.getRemovePortActions(), Messages.NodeContainerFigure_37);
                addActions(popUpMenu, portCreator.getExchangePortActions(), Messages.NodeContainerFigure_38);
            }
        }
