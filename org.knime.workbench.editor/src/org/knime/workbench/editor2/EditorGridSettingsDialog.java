...
public class EditorGridSettingsDialog extends Dialog {
    ...
    private static final ImageDescriptor IMG_PERMS = AbstractUIPlugin.imageDescriptorFromPlugin(
            KNIMEEditorPlugin.PLUGIN_ID, "icons/grid2_55.png"); //$NON-NLS-1$
    ...
    private void setValues() {
        ...
        m_xGrid.setText("" + build.getGridX()); //$NON-NLS-1$
        m_yGrid.setText("" + build.getGridY()); //$NON-NLS-1$
        settingsChanged();
    }
    ...
    protected void configureShell(final Shell newShell) {
        ...
        newShell.setText(Messages.EditorGridSettingsDialog_3);
    }
    ...
    private void createHeader(final Composite parent) {
        ...
        exec.setText(Messages.EditorGridSettingsDialog_4);
        ...
        txt.setText(Messages.EditorGridSettingsDialog_5
                + Messages.EditorGridSettingsDialog_6
                + Messages.EditorGridSettingsDialog_7);
    ...
    private void createEnablePanel(final Composite parent) {
        ...
        border.setText(Messages.EditorGridSettingsDialog_8);
        m_snap = new Button(border, SWT.CHECK);
        m_snap.setText(Messages.EditorGridSettingsDialog_9);
        ...
        m_show.setText(Messages.EditorGridSettingsDialog_10);
    ...
    private void createGridPanel(final Composite parent) {
        ...
        border.setText(Messages.EditorGridSettingsDialog_11);
        ...
        h.setText(Messages.EditorGridSettingsDialog_12);
        h.setToolTipText(Messages.EditorGridSettingsDialog_13 + WorkflowEditor.getPrefGridXSize());
        ...
        m_xGrid.setToolTipText(Messages.EditorGridSettingsDialog_14 + WorkflowEditor.getPrefGridXSize());
        ...
        v.setText(Messages.EditorGridSettingsDialog_15);
        v.setToolTipText(Messages.EditorGridSettingsDialog_16 + WorkflowEditor.getPrefGridYSize());
        ...
        m_yGrid.setToolTipText(Messages.EditorGridSettingsDialog_17 + WorkflowEditor.getPrefGridYSize());
    ...
    private void settingsChanged() {
        ...
        if (x.isEmpty()) {
            setError(Messages.EditorGridSettingsDialog_18);
            return;
        }
        try {
            int xInt = Integer.parseInt(x);
            if (xInt <= 0) {
                setError(Messages.EditorGridSettingsDialog_19);
            ...
            setError(Messages.EditorGridSettingsDialog_20);
            m_xGrid.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_RED));
            return;
        }
        ...
        if (y.isEmpty()) {
            setError(Messages.EditorGridSettingsDialog_21);
            return;
        }
        try {
            int yInt = Integer.parseInt(y);
            if (yInt <= 0) {
                setError(Messages.EditorGridSettingsDialog_22);
            ...
            setError(Messages.EditorGridSettingsDialog_23);
            m_yGrid.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_RED));
            return;
        }
