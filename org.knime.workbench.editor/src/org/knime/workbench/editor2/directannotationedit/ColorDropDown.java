...
public class ColorDropDown extends Canvas implements TransientEditAssetGroup.AssetProvider {
    ...
    private static final String SERIALIZED_COLORS_DELIMITER = ","; //$NON-NLS-1$
    ...
    private static final String[][] COLOR_GRID_HEX_VALUES =
        {{"#EF2929", "#FCAF3E", "#E9B96E", "#FCE94F", "#8AE234", "#B2CFD6", "#729FCF", "#AD7FA8", "#EFF0EE"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
            {"#CC0000", "#F57900", "#C17D11", "#EDD400", "#73D216", "#70A7B4", "#3465A4", "#75507B", "#D3D7CF"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
            {"#A40000", "#CE5C00", "#8F5902", "#FFD800", "#4E9A06", "#1B6A7D", "#204A87", "#5C3566", "#BABDB6"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
            {"#000000", "#2E3436", "#555753", "#888A85", "#BABDB6", "#D3D7CF", "#EEEEEC", "#F3F3F3", "#FFFFFF"}}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
    ...
    private static synchronized void initializeColorsIfNecessary() {
        if (DROP_SHADOW_COLOR == null) {
            ...
            BACKGROUND_COLOR = createColorFromHexString(d, "#F0F0F0"); //$NON-NLS-1$
            BORDER_COLOR = createColorFromHexString(d, "#4D4D4D"); //$NON-NLS-1$
            ...
            GRID_WELL_BORDER_COLOR = createColorFromHexString(d, "#BFBFBF"); //$NON-NLS-1$
    ...
    private static RGB deserializeRGB(final String serializedColor) {
        final String[] components = serializedColor.split("\\."); //$NON-NLS-1$
    ...
    public ColorDropDown(final Composite parent, final StyledTextEditor editor, final boolean dropShadow,
        ...
        m_customColorButton = new LabelFlatButton(this, Messages.ColorDropDown_41);
        m_customColorButton.addClickListener((source) -> {
            ...
            colorDialog.setText(Messages.ColorDropDown_42);
