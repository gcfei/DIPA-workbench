...
public class AnnotationEditFloatingToolbar extends Composite implements FlatButton.ClickListener {
    ...
    private static synchronized void initializeSWTAssetsIfNecessary() {
        if (BACKGROUND_COLOR == null) {
            ...
            BACKGROUND_COLOR = ColorDropDown.createColorFromHexString(d, "#F0F0F0"); //$NON-NLS-1$
            BORDER_COLOR = ColorDropDown.createColorFromHexString(d, "#D7D7D7"); //$NON-NLS-1$
        }
    }
    ...
    AnnotationEditFloatingToolbar(final Composite parent, final StyledTextEditor editor,
        ...
        imageLabel
            .setImage(ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/font-size-icon.png")); //$NON-NLS-1$
        ...
        m_fontSizeButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_0);
        ...
        m_boldToggleButton = new FlatButton(this, SWT.TOGGLE,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/bold-icon.png"), null, //$NON-NLS-1$
        ...
        m_boldToggleButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_1);

        m_italicToggleButton = new FlatButton(this, SWT.TOGGLE,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/italic-icon.png"), null, //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE, true);
        ...
        m_italicToggleButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_2);

        m_fontColorButton = new FlatButton(this, SWT.PUSH,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/font-color-icon.png"), //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE);
        ...
        m_fontColorButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_3);
        ...
        m_alignLeftRadioButton = new FlatButton(this, SWT.TOGGLE,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/left-align-icon.png"), null, //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE, true);
        ...
        m_alignLeftRadioButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_4);
        m_alignCenterRadioButton = new FlatButton(this, SWT.TOGGLE,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/center-align-icon.png"), null, //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE, true);
        ...
        m_alignCenterRadioButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_5);
        m_alignRightRadioButton = new FlatButton(this, SWT.TOGGLE,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/right-align-icon.png"), null, //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE, true);
        ...
        m_alignRightRadioButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_6);
        m_radioGroup =
        ...
        m_borderWidthLabelIcon.setImage(
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/border-width-icon.png")); //$NON-NLS-1$
        ...
        m_borderWidthButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_7);

        m_borderColorButton = new FlatButton(this, SWT.PUSH,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/border-color-icon.png"), //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE);
        ...
        m_borderColorButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_8);

        m_backgroundColorButton = new FlatButton(this, SWT.PUSH,
            ImageRepository.getImage(KNIMEEditorPlugin.PLUGIN_ID, "/icons/annotations/background-color-icon.png"), //$NON-NLS-1$
            DEFAULT_BUTTON_SIZE);
        ...
        m_backgroundColorButton.setToolTipText(Messages.AnnotationEditFloatingToolbar_9);
