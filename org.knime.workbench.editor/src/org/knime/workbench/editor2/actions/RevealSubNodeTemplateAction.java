...
public class RevealSubNodeTemplateAction extends AbstractNodeAction {
    /** Action ID. */
    public static final String ID = "knime.action.sub_node_reveal_template"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.RevealSubNodeTemplateAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.RevealSubNodeTemplateAction_2;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/meta/metanode_link_reveal.png"); //$NON-NLS-1$
    }
        ...
        for (NodeContainerEditPart p : nodes) {
            ...
            if (wraps(model, SubNodeContainer.class)) {
                ...
                final String rootPath =
                    rootStore.getFullName().endsWith("/") ? rootStore.getFullName() : rootStore.getFullName() + "/"; //$NON-NLS-1$ //$NON-NLS-2$
