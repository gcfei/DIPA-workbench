...
public class HideNodeNamesAction extends AbstractClipboardAction {
    ...
    public static final String ID = "knime.action.hide_node_names"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.HideNodeNamesAction_1 + getHotkey("knime.commands.hideNodeNames"); //$NON-NLS-2$
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/hideNodeNames.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/hideNodeNames_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.HideNodeNamesAction_5;
    }
