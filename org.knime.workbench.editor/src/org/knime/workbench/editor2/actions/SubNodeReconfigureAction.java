...
public class SubNodeReconfigureAction extends AbstractNodeAction {
    ...
    /** id of this action. */
    public static final String ID = "knime.action.sub_node_reconfigure"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.SubNodeReconfigureAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.SubNodeReconfigureAction_2;
    }
