...
public class UnlinkNodesAction extends AbstractLinkNodesAction {
    ...
    public static final String ID = "knime.actions.unlinknodes"; //$NON-NLS-1$
    /** org.eclipse.ui.commands command ID for this action. **/
    private static final String COMMAND_ID = "knime.commands.unlinknodes"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.UnlinkNodesAction_2 + getHotkey(COMMAND_ID);
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/unlink_nodes.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/unlink_nodes_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.UnlinkNodesAction_5;
    }
