...
public class LockSubNodeAction extends AbstractNodeAction {
    ...
    /** Action ID. */
    public static final String ID = "knime.action.sub_node_lock"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.LockSubNodeAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.LockSubNodeAction_2;
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodes) {
        ...
        try {
            ...
            String msg = Messages.LockSubNodeAction_4 + e.getMessage();
            LOGGER.error(msg, e);
            MessageDialog.openError(shell, Messages.LockSubNodeAction_5, msg);
        }
    }
