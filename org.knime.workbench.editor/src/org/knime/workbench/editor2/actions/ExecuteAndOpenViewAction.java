...
public class ExecuteAndOpenViewAction extends AbstractNodeAction {
     ...
     */
    public static final String ID = "knime.action.executeandopenview"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.ExecuteAndOpenViewAction_1 + getHotkey("knime.commands.executeAndOpenView"); //$NON-NLS-2$
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/executeAndView.GIF"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/executeAndView_diabled.PNG"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        String tooltip = Messages.ExecuteAndOpenViewAction_5;
        ...
        if (parts.length == 1) {
            ...
            if (nc.hasInteractiveView() || nc.getInteractiveWebViews().size() > 0) {
                return tooltip + Messages.ExecuteAndOpenViewAction_6;
            }
        } else {
            tooltip += Messages.ExecuteAndOpenViewAction_7;
        }
        return tooltip + Messages.ExecuteAndOpenViewAction_8;
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        LOGGER.debug(Messages.ExecuteAndOpenViewAction_9
                + nodeParts.length + Messages.ExecuteAndOpenViewAction_10);
