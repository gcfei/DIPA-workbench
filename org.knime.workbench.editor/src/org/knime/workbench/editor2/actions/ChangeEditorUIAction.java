...
public class ChangeEditorUIAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.editor.editorUISettings"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.ChangeEditorUIAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/editor_UI_settings_16.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.ChangeEditorUIAction_3;
    }
