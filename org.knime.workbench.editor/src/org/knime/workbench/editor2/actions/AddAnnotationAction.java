...
public class AddAnnotationAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.addannotation"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.AddAnnotationAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/annotation.png"); //$NON-NLS-1$
    }
