...
public class BringAnnotationForwardAction extends AbstractAnnotationReorderingAction {
    ...
    public static final String ID = "knime.action.annotationForward"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.BringAnnotationForwardAction_1 + getHotkey("knime.commands.editor.bringForward"); //$NON-NLS-2$
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/annotation-forward.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/annotation-forward_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.BringAnnotationForwardAction_5;
    }
}
