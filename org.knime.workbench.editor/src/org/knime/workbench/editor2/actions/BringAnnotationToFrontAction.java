...
public class BringAnnotationToFrontAction extends AbstractAnnotationReorderingAction {
    ...
    public static final String ID = "knime.action.annotationToFront"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.BringAnnotationToFrontAction_1 + getHotkey("knime.commands.editor.bringToFront"); //$NON-NLS-2$
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/annotation-to-front.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/annotation-to-front_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.BringAnnotationToFrontAction_5;
    }
}
