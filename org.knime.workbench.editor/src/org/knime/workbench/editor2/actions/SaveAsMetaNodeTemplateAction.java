...
public class SaveAsMetaNodeTemplateAction extends AbstractNodeAction {
    ...
    /** Action ID. */
    public static final String ID = "knime.action.meta_node_save_as_template"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.SaveAsMetaNodeTemplateAction_1;
    }
    ...
    public String getToolTipText() {
        return Messages.SaveAsMetaNodeTemplateAction_2;
    }
...
//        Workbench.getInstance().getActiveWorkbenchWindow().getActivePage().findView(ID)
        ...
        if (validMountPointList.isEmpty()) {
            throw new IllegalStateException(Messages.SaveAsMetaNodeTemplateAction_4
                    + Messages.SaveAsMetaNodeTemplateAction_5);
        }
        ...
        dialog.setTitle(Messages.SaveAsMetaNodeTemplateAction_6);
        dialog.setHeader(Messages.SaveAsMetaNodeTemplateAction_7);
        dialog.setValidator(new Validator() {
            ...
            public String validateSelectionValue(final AbstractExplorerFileStore selection, final String name) {
                ...
                return Messages.SaveAsMetaNodeTemplateAction_8;
            }
        });
