...
public class ResumeLoopAction extends AbstractNodeAction {
     ...
     */
    public static final String ID = "knime.action.resumeloop"; //$NON-NLS-1$
    ...
    public String getText() {
        return Messages.ResumeLoopAction_1;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/resume.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getIconDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/resume_diabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.ResumeLoopAction_4;
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        LOGGER.debug(Messages.ResumeLoopAction_5
                + nodeParts.length + Messages.ResumeLoopAction_6);
