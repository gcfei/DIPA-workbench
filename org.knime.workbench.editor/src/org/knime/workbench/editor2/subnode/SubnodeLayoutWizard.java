...
public class SubnodeLayoutWizard extends Wizard {
    ...
    public void addPages() {
        setWindowTitle(Messages.SubnodeLayoutWizard_0);
        setDefaultPageImageDescriptor(
            ImageRepository.getImageDescriptor(KNIMEEditorPlugin.PLUGIN_ID, "icons/layout_55.png")); //$NON-NLS-1$
        ...
        m_page = new SubnodeLayoutJSONEditorPage(Messages.SubnodeLayoutWizard_2);
