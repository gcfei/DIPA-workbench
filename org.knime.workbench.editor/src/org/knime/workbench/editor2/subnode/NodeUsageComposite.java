...
public class NodeUsageComposite extends Composite {
    ...
    public NodeUsageComposite(final Composite parent, final Map<NodeIDSuffix, ViewHideable> viewNodes,
        ...
        if (viewNodes.size() > 0) {
            ...
            createMessage(Messages.NodeUsageComposite_0);
        }
    }
    ...
    private void createNodeGrid(final SubNodeContainer subNodeContainer,
        ...
        for (Entry<NodeIDSuffix, ViewHideable> entry : viewNodes.entrySet()) {
            ...
            wizardButton.setToolTipText(Messages.NodeUsageComposite_4);
            ...
            if (model instanceof DialogNode) {
                ...
                dialogButton.setToolTipText(Messages.NodeUsageComposite_5);
    ...
    private static Composite createNodeLabelComposite(final Composite parent, final NodeID nodeID,
        ...
        if (nodeContainer == null) {
            ...
            iconLabel.setToolTipText(Messages.NodeUsageComposite_7);
        ...
        if (nodeContainer == null) {
            nodeName = Messages.NodeUsageComposite_10;
            ...
            nodeLabel.setToolTipText(Messages.NodeUsageComposite_11);
        } else {
