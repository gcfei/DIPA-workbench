...
public class DescriptionView extends ViewPart implements ISelectionListener {
    ...
    public static final String ID = "org.knime.workbench.helpview"; //$NON-NLS-1$

    private static final String MIDST_EDIT_WARNING_TEXT =
        Messages.DescriptionView_1;
    private static final String[] DIALOG_BUTTON_LABELS = {Messages.DescriptionView_2, Messages.DescriptionView_3};
    ...
    private static void displayDirtyWarning(final Runnable postDisplayAction, final AbstractMetaView dirtyView) {
        ...
        d.syncExec(() -> {
            ...
            final int response = MessageDialog.open(MessageDialog.QUESTION, s, Messages.DescriptionView_4,
