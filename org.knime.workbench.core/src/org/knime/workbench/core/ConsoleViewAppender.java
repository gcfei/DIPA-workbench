...
public final class ConsoleViewAppender extends Writer {
    ...
    public static final String CONSOLE_NAME = Messages.ConsoleViewAppender_0;
    ...
    public static final ConsoleViewAppender FATAL_ERROR_APPENDER =
            new ConsoleViewAppender(COLOR_FATAL_ERROR, Messages.ConsoleViewAppender_1,
                    NodeLogger.LEVEL.FATAL);

    /** Appender: error. * */
    public static final ConsoleViewAppender ERROR_APPENDER =
            new ConsoleViewAppender(COLOR_ERROR, Messages.ConsoleViewAppender_2,
                    NodeLogger.LEVEL.ERROR);

    /** Appender: info. */
    public static final ConsoleViewAppender WARN_APPENDER =
            new ConsoleViewAppender(COLOR_WARN, Messages.ConsoleViewAppender_3, NodeLogger.LEVEL.WARN);

    /** Appender: warn. */
    public static final ConsoleViewAppender INFO_APPENDER =
            new ConsoleViewAppender(COLOR_INFO, Messages.ConsoleViewAppender_4, NodeLogger.LEVEL.INFO);

    /** Appender: debug. */
    public static final ConsoleViewAppender DEBUG_APPENDER =
            new ConsoleViewAppender(COLOR_DEBUG, Messages.ConsoleViewAppender_5,
    ...
    public static final ConsoleViewAppender FORCED_APPENDER =
            new ConsoleViewAppender(COLOR_INFO, Messages.ConsoleViewAppender_6, NodeLogger.LEVEL.ALL);
