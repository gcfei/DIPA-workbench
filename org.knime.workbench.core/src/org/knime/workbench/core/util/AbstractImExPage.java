...
public abstract class AbstractImExPage extends WizardPage {
    ...
    protected AbstractImExPage(final String title, final String description,
        ...
        super("wizardPage", title, export ? ImageRepository //$NON-NLS-1$
                .getImageDescriptor(SharedImages.ExportBig) : ImageRepository
                .getImageDescriptor(SharedImages.ImportBig));
        setDescription(description);
        m_export = export;
        m_extensions.add("*.*"); //$NON-NLS-1$
        m_extensionDescriptions.add("All files"); //$NON-NLS-1$
    }
    ...
    public void createControl(final Composite parent) {
        ...
        label.setText(Messages.AbstractImExPage_3
                + (m_export ? Messages.AbstractImExPage_4 : Messages.AbstractImExPage_5));
        ...
        selectFileButton.setText(Messages.AbstractImExPage_6);
        selectFileButton.setToolTipText(Messages.AbstractImExPage_7);
        selectFileButton.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(final SelectionEvent se) {
                ...
                fileDialog.setText(Messages.AbstractImExPage_8
                        + (m_export ? Messages.AbstractImExPage_9 : Messages.AbstractImExPage_10) + Messages.AbstractImExPage_11);
                if (m_filename != null) {
