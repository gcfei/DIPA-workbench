...
public class HorizAlignLayoutAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.horizalignlayout"; //$NON-NLS-1$
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getImageDescriptor(Activator.PLUGIN_ID, "icons/halign.png"); //$NON-NLS-1$
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getImageDescriptor(Activator.PLUGIN_ID, "icons/halign_disabled.png"); //$NON-NLS-1$
    }
    ...
    public String getToolTipText() {
        return Messages.HorizAlignLayoutAction_3;
    }
