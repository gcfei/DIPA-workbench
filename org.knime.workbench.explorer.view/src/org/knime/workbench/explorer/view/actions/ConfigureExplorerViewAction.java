...
public class ConfigureExplorerViewAction extends ExplorerAction {
    private static final String TOOLTIP
            = Messages.getString("ConfigureExplorerViewAction.0"); //$NON-NLS-1$
    ...
    public ConfigureExplorerViewAction(final ExplorerView viewer,
        ...
        super(viewer, Messages.getString("ConfigureExplorerViewAction.1")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.configure-view"; //$NON-NLS-1$
    }
