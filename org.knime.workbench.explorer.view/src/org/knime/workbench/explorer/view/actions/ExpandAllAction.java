...
public class ExpandAllAction extends ExplorerAction {
    private static final String TOOLTIP = Messages.getString("ExpandAllAction.0"); //$NON-NLS-1$

    /**
     * @param viewer the viewer
     */
    public ExpandAllAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("ExpandAllAction.1")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.expandall"; //$NON-NLS-1$
    }
