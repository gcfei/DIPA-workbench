...
public class QuickformExecuteWizardPage extends WizardPage {
    ...
    QuickformExecuteWizardPage(final QuickformExecuteWizard wizard,
        ...
        super(pageName);
        setTitle(Messages.getString("QuickformExecuteWizardPage.1")); //$NON-NLS-1$
        setDescription(
            Messages.getString("QuickformExecuteWizardPage.2")); //$NON-NLS-1$
    ...
    public void createControl(final Composite parent) {
     // create a new panel holding all Swing/AWT quickform components
        ...
        if (m_qnodes.isEmpty()) {
            ...
            l.setText(Messages.getString("QuickformExecuteWizardPage.3")); //$NON-NLS-1$
