...
public class CollapseAction extends ExplorerAction {
    ...
    public static final ImageDescriptor IMG_COLL =
        ...
        "icons/collapse.png"); //$NON-NLS-1$

    private static final String TOOLTIP = Messages.getString("CollapseAction.1"); //$NON-NLS-1$
    ...
    public CollapseAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("CollapseAction.2")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.collapse"; //$NON-NLS-1$
    }
