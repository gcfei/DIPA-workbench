...
public class CopyLocationAction extends ExplorerAction {
    ...
    public CopyLocationAction(final ExplorerView viewer, final Clipboard cb) {
        super(viewer, Messages.getString("CopyLocationAction.2")); //$NON-NLS-1$
        m_cb = cb;
        setToolTipText(Messages.getString("CopyLocationAction.3")); //$NON-NLS-1$
