...
public class ExpandAction extends ExplorerAction {
    ...
    public static final ImageDescriptor IMG_EXP =
        ...
        "icons/expand.png"); //$NON-NLS-1$

    private static final String TOOLTIP = Messages.getString("ExpandAction.1"); //$NON-NLS-1$

    /**
     * @param viewer the viewer
     */
    public ExpandAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("ExpandAction.2")); //$NON-NLS-1$
    ...
    @Override
    public String getId() {
        return "org.knime.workbench.explorer.view.action.expand"; //$NON-NLS-1$
    }
