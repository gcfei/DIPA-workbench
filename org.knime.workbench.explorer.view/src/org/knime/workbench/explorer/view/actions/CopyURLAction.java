...
public class CopyURLAction extends ExplorerAction {
    ...
    public static final String URLCOPY_ACTION_ID =
            "org.knime.workbench.explorer.action.copy-url"; //$NON-NLS-1$
    ...
    public CopyURLAction(final ExplorerView viewer, final Clipboard cb) {
        super(viewer, Messages.getString("CopyURLAction.1")); //$NON-NLS-1$
        m_cb = cb;
        setToolTipText(Messages.getString("CopyURLAction.2")); //$NON-NLS-1$
