...
public class DeprecatedEditMetadataAction extends ExplorerAction {
    ...
    public static final String METAINFO_ACTION_ID = "org.knime.workbench.explorer.action.openMetaInfo"; //$NON-NLS-1$

    private static final ImageDescriptor ICON =
        AbstractUIPlugin.imageDescriptorFromPlugin(KNIMEUIPlugin.PLUGIN_ID, "icons/meta_info_edit.png"); //$NON-NLS-1$
    ...
    public DeprecatedEditMetadataAction(final ExplorerView viewer) {
        super(viewer, "Edit Meta Information..."); //$NON-NLS-1$
    ...
    public void run() {
        ...
        MessageDialog.openInformation(s, Messages.getString("DeprecatedEditMetadataAction.3"), //$NON-NLS-1$
            Messages.getString("DeprecatedEditMetadataAction.4") //$NON-NLS-1$
                    + Messages.getString("DeprecatedEditMetadataAction.5")); //$NON-NLS-1$
    }
