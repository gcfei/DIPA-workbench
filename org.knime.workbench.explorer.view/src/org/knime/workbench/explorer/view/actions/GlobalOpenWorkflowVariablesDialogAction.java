...
public class GlobalOpenWorkflowVariablesDialogAction extends ExplorerAction {
    ...
    public static final String WFVAR_ACTION_ID =
            "org.knime.workbench.explorer.action.workflow-vars-dialog"; //$NON-NLS-1$

    /**
     * @param viewer the associated tree viewer
     */
    public GlobalOpenWorkflowVariablesDialogAction(final ExplorerView viewer) {
        super(viewer, Messages.getString("GlobalOpenWorkflowVariablesDialogAction.1")); //$NON-NLS-1$
    }
    ...
    public void run() {
        ...
        if (!(wfStore instanceof LocalExplorerFileStore)) {
            LOGGER.error(Messages.getString("GlobalOpenWorkflowVariablesDialogAction.2")); //$NON-NLS-1$
            return;
        }
        ...
        if (ExplorerFileSystemUtils
            ...
            LOGGER.info(Messages.getString("GlobalOpenWorkflowVariablesDialogAction.3") //$NON-NLS-1$
                    + Messages.getString("GlobalOpenWorkflowVariablesDialogAction.4")); //$NON-NLS-1$
    ...
    private void showCantEditVarsLockMessage() {
        ...
        mb.setText(Messages.getString("GlobalOpenWorkflowVariablesDialogAction.5")); //$NON-NLS-1$
        mb.setMessage(Messages.getString("GlobalOpenWorkflowVariablesDialogAction.6") //$NON-NLS-1$
                + Messages.getString("GlobalOpenWorkflowVariablesDialogAction.7")); //$NON-NLS-1$
        mb.open();
    }
}
