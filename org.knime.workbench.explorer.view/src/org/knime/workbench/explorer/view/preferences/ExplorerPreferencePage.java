...
public class ExplorerPreferencePage extends FieldEditorPreferencePage
    ...
    public static final String ID
            = "org.knime.workbench.explorer.view.explorer"; //$NON-NLS-1$
   ...
   public ExplorerPreferencePage() {
       super(Messages.getString("ExplorerPreferencePage.1"), null, GRID); //$NON-NLS-1$
       setDescription(Messages.getString("ExplorerPreferencePage.2")); //$NON-NLS-1$
   }
    ...
    protected void createFieldEditors() {
        ...
        m_linkTemplateEditor = new ComboFieldEditor(
                ...
                Messages.getString("ExplorerPreferencePage.3"), //$NON-NLS-1$
                new String[][] {
