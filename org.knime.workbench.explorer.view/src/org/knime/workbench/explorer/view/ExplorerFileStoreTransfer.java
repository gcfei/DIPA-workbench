...
public class ExplorerFileStoreTransfer extends ByteArrayTransfer {
    ...
    private static final String TYPE_NAME = "knime-explorerfs-transfer"; //$NON-NLS-1$
    ...
    public void javaToNative(final Object object,
        ...
        if (isSupportedType(transferData)) {
            ...
            try {
                ...
                LOGGER.error(Messages.getString("ExplorerFileStoreTransfer.1"), e); //$NON-NLS-1$
            }
        }
    }
    ...
    public Object nativeToJava(final TransferData transferData) {
        if (isSupportedType(transferData)) {
            ...
            try {
                ...
                LOGGER.error(Messages.getString("ExplorerFileStoreTransfer.2"), ex); //$NON-NLS-1$
                return null;
            } catch (URISyntaxException use) {
                LOGGER.error(Messages.getString("ExplorerFileStoreTransfer.3"), use); //$NON-NLS-1$
                return null;
            }
